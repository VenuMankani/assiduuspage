...
const monthlyData = [
  { month: 'January', data: [215, 70, 135, 20, 46, 44, 60, 32, 80, 40] },
  { month: 'February', data: [30, 65, 40, 55, 50, 42, 65, 35, 75, 38] },
  { month: 'March', data: [35, 60, 50, 58, 55, 48, 70, 138, 70, 42] },
  { month: 'April', data: [40, 55, 55, 50, 60, 52, 75, 145, 65, 48] },
  { month: 'May', data: [45, 50, 60, 45, 70, 56, 80, 50, 60, 50] },
  { month: 'June', data: [50, 45, 65, 40, 75, 60, 85, 55, 55, 52] },
  { month: 'July', data: [55, 40, 170, 35, 80, 65, 190, 60, 150, 54] },
  { month: 'August', data: [60, 35, 175, 30, 85, 70, 95, 65, 45, 56] },
  { month: 'September', data: [65, 30, 80, 28, 90, 75, 100, 70, 40, 58] },
  { month: 'October', data: [70, 25, 85, 25, 95, 80, 105, 75, 35, 60] },
  { month: 'November', data: [75, 20, 190, 22, 100, 185, 110, 80, 30, 62] },
